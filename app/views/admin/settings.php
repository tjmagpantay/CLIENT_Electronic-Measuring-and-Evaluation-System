...
<div class="row g-4">
            ...
            <div class="d-flex align-items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <span class="badge rounded-small px-2 py-1 fw-normal"
                        style="background-color:#F3AF0E; color:#092C4C; font-size:.70rem;">
                        Admin
                    </span>
                </div>
            </div>
    ...
    <div class="col-lg-8">
        <div class="settings-card p-4">
            ...
            <form action="<?php echo env('APP_URL'); ?>/admin/updateprofile" method="POST" enctype="multipart/form-data">
