                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item <?php echo $a['is_active'] ? 'text-warning' : 'text-success'; ?>"
                                                    href="<?php echo env('APP_URL'); ?>/superadmin/toggleannouncement/<?php echo $a['announcement_id']; ?>"
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger"
                                                    href="<?php echo env('APP_URL'); ?>/superadmin/deleteannouncement/<?php echo $a['announcement_id']; ?>"
